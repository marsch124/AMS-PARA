...
final class ShareViewController: UIViewController {
    ...
    private func save(_ item: CaptureItem) {
        guard let outboxURL else {
            extensionContext?.cancelRequest(withError: NSError(domain: "ParagonShare", code: 1, userInfo: [
    ...
    private func cancel() {
        extensionContext?.cancelRequest(withError: NSError(domain: "ParagonShare", code: NSUserCancelledError))
    }
}
